            ...
            <div class="col-lg-5 pt-3" style="margin-bottom:5%;">
                ...
                <div class="box text-center">
                     <div class="box2 text-center">
                         <br>
                            <br>
                          <font class="lblfont">Register</font>
                     </div>
                     <br>
                     <form action="controllerReg.php" method="POST">
                     <?php echo error1(); ?>
                     <div class="divc"><font class="lblfont2">Email</font></div>
                    <div class="divc"><input type="text" name="email" id="email" style="width: 80%;" required></div>
                    <div style="width: 100%; height: 1rem;"></div>
                    <div class="divc"><font class="lblfont2">Password</font></div>
                    <div class="divc"><input type="password" name="password" id="password" style="width: 80%;" required></div>
                    <div style="width: 100%; height: 1rem;"></div>
                    <div class="divc"><font class="lblfont2">First Name</font></div>
                    <div class="divc"><input type="text" name="fname" id="fname" style="width: 80%;" required></div>
                    <div style="width: 100%; height: 1rem;"></div>
                    <div class="divc"><font class="lblfont2">Last Name</font></div>
                    <div class="divc"><input type="text" name="lname" id="lname" style="width: 80%;" required></div>
                    <div style="width: 100%; height: 1rem;"></div>
                    <div class="divc"><font class="lblfont2">Middle Initial</font></div>
                    <div class="divc"><input type="text" name="midi" id="midi" style="width: 80%;" required></div>
                    <div style="width: 100%; height: 1rem;"></div>
                    
                    <br>
                    <br>
                   <button type="submit" class="btn1 btn" name="button1" id="login_btn">
                        Register
                    </button></form>
