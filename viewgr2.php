                ...
                <div class=" row" style="min-height: 192px; max-height: 192px; min-width: 1800px; max-width: 1800px;">
                      <!-- <div class="col-lg-1 pt-5" style="padding-left: 6rem;">
                        ...
                        <div class=" pt-3" style="min-width: 1800px; max-width: 1800px; padding-left: 6rem; width: 1800px; min-height: 192px; max-height: 192px;">
                                ...
                                &nbsp; &nbsp; &nbsp; &nbsp; 
                                 <img src="usn2.png" class="headimg3">
...
<tr>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Student Name: <?php echo $lname?>, <?php echo $fname?> </tr><br>
<tr>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Student ID: 2016094282</tr><br>
<tr>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Status: Regular</tr><br>
<tr>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Deficiencies: 0 Units</tr><br>
<tr>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Backlog: 0 Units</tr><br>
</table>
<!-- </table>
<table class ="indoors">
<tr>ss</tr><br>
...
<br><br>
<div class ="butons">
<a href="home2.php"><button class ="btn btn-primary"type="submit" name="btnBack" id="btnBack">Backlog</button></a>
<a href="home2.php"><button class ="btn btn-primary"type="submit" name="btnBack" id="btnBack">Deficiencies</button></a>
<a href="home2.php"><button class ="btn btn-primary"type="submit" name="btnBack" id="btnBack">Passed Subjects</button></a>
