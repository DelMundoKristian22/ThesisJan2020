...
<body>
            ...
            <div id="sidebar-wrapper" class="sidebardes">
                 ...
                 ?>
                  <ul class="sidebar-nav">
                         <li><div ><a href="home.php">View Accounts</a></div></li>
                         <li><a href="adminsummary.php" style="background-color:rgb(31, 30, 29);">View Summaries</a></li>
    ...
    <div id="page-content-wrapper">
        <div class="container-fluid header1">
                ...
                <div class=" row" style="min-height: 192px; max-height: 192px; min-width: 1500px; max-width: 1500px;">
                      <!-- <div class="col-lg-1 pt-5" style="padding-left: 6rem;">
                                
                        </div> -->
                        <div class=" pt-3" style="min-width: 1500px; max-width: 1500px; padding-left: 6rem; width: 1500px; min-height: 192px; max-height: 192px;">
...
<?php
                ...
                <tr>
					...
					<td class = "nobd"> <button class = "btn btn-primary" type="submit" name="g1" id="g1" value="<?php echo $row['SID']; ?>" > View Grades</button> </td>
                </tr>
                    <?php
                }
                ?>
